        ...
        for country, venues in self.target_venues.items():
            ...
            for venue_code in venues:
                try:
                    ...
                    engine_data = self.engine.analyze_venue_bias(venue_code, years_back=self.years)
                    
                    if not engine_data:
                        # Handle 'Insufficient Data' case
                        # Legacy fixture uses string "Insufficient Data" or omits?
                        # Let's check fixture... "ENG_DERBY": "Insufficient Data"
