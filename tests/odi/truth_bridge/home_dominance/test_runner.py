...
class HomeDominanceTruthBridge(TruthBridgeBase):
    ...
    def run(self):
        legacy_path = 'tests/odi/regression_suite/analyze_home_dominance/fixtures/analyze_home_dominance_latest_test_run_results.json'
        ...
        for idx, team_name in enumerate(teams_considered):
            ...
            # Check if team exists in legacy data (keys might be team names)
