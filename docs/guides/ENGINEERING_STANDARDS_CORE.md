...
This document is the **absolute and 
non-negotiable source of truth** for all 
code generation, refactoring, and 
architectural decisions. Human architects 
read and maintain this file. AI agents 
receive scoped versions: 
ENGINEERING_STANDARDS_BACKEND.md or 
ENGINEERING_STANDARDS_FRONTEND.md. 
When any rule changes, update this file 
first, then propagate to the affected 
agent file(s).
...
propagate changes to the affected agent 
file (BACKEND and/or FRONTEND).*
