...
```powershell
python formats/odi/tests/truth_bridge/analyze_venue_matchup/test_runner.py
```
...
```powershell
$env:SEED_MODE="1"; python formats/odi/tests/truth_bridge/analyze_venue_matchup/test_runner.py
```
