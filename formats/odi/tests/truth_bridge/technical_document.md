...
2.  **Zero Hardcoding:** Our tests never hardcode team colors or roles. They import from `config/shared/team_colors.py` and `formats/odi/config/players.py`. If you change a mapping, the entire bridge updates automatically.
